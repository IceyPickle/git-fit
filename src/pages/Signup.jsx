      ...
      <div className="auth-card">
        <header className="auth-header">
          ...
          <p className="auth-sub">
            Save your workouts, notes, and regimen. It’s free.
          </p>
        </header>
        ...
        <form className="auth-form" onSubmit={onSubmit} noValidate>
          ...
          <input
            id="password" name="password" type="password" placeholder="At least 8 chars, include a number"
          ...
          <input
            id="confirm" name="confirm" type="password" placeholder="Re-enter your password"
